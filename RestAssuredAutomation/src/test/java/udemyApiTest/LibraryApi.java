...
public class LibraryApi {
	...
	public void postBooks(String isbn,String aisle)
	{		
	...
	{		
		...
		Response res = given().
		header("Content-Type","application/json").
		body(GenerateStringFromResource("C:\\Java selenium projects\\RestAssuredUdemy\\RestAssuredAutomation\\src\\main\\resources\\payload\\postLibraryBook.json")).
		when().
		post("/Library/Addbook.php").
		then().assertThat().statusCode(200).extract().response();
		String strResponse= res.asString();
