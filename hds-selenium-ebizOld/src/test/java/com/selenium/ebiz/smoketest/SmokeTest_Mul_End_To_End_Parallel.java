...
import com.selenium.ebiz.baseclass.BaseClass_ParallelExecution;
...
public class SmokeTest_Mul_End_To_End_Parallel extends BaseClass_ParallelExecution{
	...
	public void driverSetup(String browserType) throws Exception {
	...
	public void testLogin() throws Exception {
		...
		//WaitTool.hardWait();
		homePage = loginPage.loginToHDSMultiBrowser();
	...
	public void addToSavedListFromShoppingCart() throws Exception{
		...
		//Assert.assertTrue(shoppingCartPage.getProductNameText().contains(shoppingCartPage.getAddToListModalTitleText()));
		System.out.println("*****");
		Assert.assertTrue(shoppingCartPage.isAddToExistingOrCreateNewListTitleTextDisplayed());
		System.out.println("Add to existing or create new listing is displayed");
		Assert.assertTrue(shoppingCartPage.isDisplayedExistingOrNewTabsOnAddToListModal());
		System.out.println("Existing and New tabs displayed");
		//Assert.assertTrue(shoppingCartPage.isDisplayedDefaultTabSelectedCorrectly());
