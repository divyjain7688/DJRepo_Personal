...
public class MyAccountQuickLinksInUtilityBarLoggedInUser_WORKING extends BaseClass{
	...
	/**
	 * 
	 * Validating My Account quick links on utility bar  for Logged in User and Click on each link should be redirected to 
	 ...
	 */
	@Test
	public void verifyMyAccountQuickLinksInUtilityBarLoggedInUser() throws Exception {	
		WaitTool.hardWait();
