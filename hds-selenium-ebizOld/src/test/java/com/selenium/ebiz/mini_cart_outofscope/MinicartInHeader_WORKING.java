...
public class MinicartInHeader_WORKING extends BaseClass{
	...
	//@Test
	public void verifyMiniCartWidgetInHeaderTest() throws Exception {
		...
		if(minicartPage.isDisplayedHeaderMiniCartEmpty()) {			
			...
			Assert.assertTrue(minicartPage.isDisplayedMinicartSubtotal() && minicartPage.IsDisplayedMiniCartHeaderDisplayTotalNumberOfItems() && minicartPage.IsDisplayedViewCartButton() );
